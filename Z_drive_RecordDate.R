...
# This script concatenates all date related fields and creates RECDATE from clinic date and letter date and can be added to all
# other scripts that analyse ExECT output.

# Using seizure frequency output as an example
